...
export function ContactPage() {
  ...
  if (isSubmitted) {
    return (
      <>
        <Helmet>
          <title>תודה על הפנייה | הצעות נישואים ירושלים</title>
  ...
  return (
    <>
      <Helmet>
        <title>יצירת קשר - הצעת נישואין בירושלים | תכנון מלא</title>
        <meta name="description" content="צרו קשר לתכנון הצעת נישואין בירושלים. שיחת ייעוץ חינם, מענה תוך 30 דקות, זמינות 24/7. טלפון: 050-935-1650" />
        <link rel="canonical" href="https://jerusalemproposals.co.il/contact" />
        
        <script type="application/ld+json">
          {JSON.stringify({
            "@context": "https://schema.org",
            "@type": "ContactPage",
            "name": "יצירת קשר - הצעות נישואים ירושלים",
            "description": "צרו קשר לתכנון הצעת נישואין בירושלים",
            "url": "https://jerusalemproposals.co.il/contact"
          })}
        </script>
      </Helmet>

...
export function PrivacyPage() {
  return (
    <>
      <Helmet>
        <title>מדיניות פרטיות - הצעות נישואים ירושלים | הגנה על המידע האישי</title>
        <meta name="description" content="מדיניות פרטיות מפורטת לאתר הצעות נישואים ירושלים. איך אנחנו אוספים, משתמשים ומגינים על המידע האישי שלכם. GDPR compliant." />
        <link rel="canonical" href="https://jerusalemproposals.co.il/privacy" />
